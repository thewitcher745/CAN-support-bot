...
TR_BUTTONS = {
    ...
    # Results Menu
    "AUGUST_2025": "📅 2025 Eylül Ayı",
    "JULY_2025": "📅 2025 Temmuz Ayı",
...
EN_KEYBOARDS = {
    ...
    "RESULTS": InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    EN_BUTTONS["AUGUST_2025"], callback_data="AUGUST_2025"
                ),
                InlineKeyboardButton(
                    EN_BUTTONS["JULY_2025"], callback_data="JULY_2025"
                ),
            ],
            [
                InlineKeyboardButton(
...
TR_KEYBOARDS = {
    ...
    "RESULTS": InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    TR_BUTTONS["AUGUST_2025"], callback_data="AUGUST_2025"
                ),
                InlineKeyboardButton(
                    TR_BUTTONS["JULY_2025"], callback_data="JULY_2025"
                ),
            ],
            [
                InlineKeyboardButton(
